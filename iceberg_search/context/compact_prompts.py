...
Purpose: the diver reviews these findings to recall what was explored and what was discovered, then decides the next action. Preserve the exploration trace and information density. This is lossy compression, not summarization.
</goal>
