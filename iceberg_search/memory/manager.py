...
PREFERENCE_DEFINITIONS = {
    ...
    "prefer_primary_sources": {
        "subject": "一手来源偏好",
        "true": "Iceberg Search 应优先使用官方文档、原始报告、数据集和其他一手来源。",
        "false": "用户不要求 Iceberg Search 优先使用一手来源。",
        "keywords": ["一手来源", "官方文档", "原始数据"],
    },
    "prefer_academic_sources": {
        "subject": "学术来源偏好",
        "true": "Iceberg Search 应优先使用论文和学术资料。",
        "false": "用户不要求 Iceberg Search 优先使用学术资料。",
    ...
    def save_preferences(
        ...
        for key, definition in PREFERENCE_DEFINITIONS.items():
            ...
            item = MemoryItem(
                ...
                content=content,
                topics=["Iceberg Search", "research preferences"],
        ...
        if preferences.research_context.strip():
            context = MemoryItem(
                ...
                topics=["Iceberg Search", "user research background"],
